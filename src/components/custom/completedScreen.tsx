...
const CompletedScreen = ({ levelName, currentXp, nextTierXp, xpIncrease }: CompletedScreenProps) => {
    ...
    const percentFilled = (xp / nextTierXp) * 100;
        ...
        <>
            ...
            <div className='absolute z-10 inset-0 flex justify-center items-center'>
                <div className='flex flex-col gap-6 items-center justify-center'>
                    ...
                    <p className='text-6xl text-[#49D8E9] mt-2'>+20 Ratings</p>
                    <div className='relative flex items-center justify-between bg-[#000928] px-6 py-4 rounded-4xl w-[30vw] shadow-[0_0_20px_#49D8E9] border border-cyan-400'>
                        <div className="relative flex-1 h-15 rounded-4xl overflow-hidden">
                            ...
                            />
                            <p className='absolute inset-0 flex items-center justify-center text-4xl text-[#000928] font-bold z-10'>
                                {xp} / {nextTierXp} XP
                            </p>
                        </div>
                    </div>
